...
- Open the OpenKnowledge app. On first launch, approve the **Connect your AI tools to OpenKnowledge** dialog — it wires up your AI editors and can add the `ok` command to your terminal. If you skip it, re-open it later from **File → Set up OpenKnowledge integrations…**.
